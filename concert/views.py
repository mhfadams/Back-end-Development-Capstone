...
def songs(request):
    # songs = {"songs":[]}
    dummy_song_list = [{"id":1,"title":"duis faucibus accumsan odio curabitur convallis","lyrics":"Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis."}]
    return render(request, "songs.html", {"songs": dummy_song_list})



def photos(request):
    # photos = []
    dummy_data = [{"id": 1, "pic_url": "http://dummyimage.com/136x100.png/5fa2dd/ffffff", "event_country": "United States", "event_state": "District of Columbia", "event_city": "Washington", "event_date": "11/16/2022" }]
